...
nav.top {
  ...
  background: linear-gradient(to bottom, var(--nav-grad-1), var(--nav-grad-2));
...
.brand .glyph {
  ...
  color: var(--glyph-fg); font-weight: 700; font-size: 11px;
...
.icon-btn:hover { color: var(--text-1); background: var(--row-hi); border-color: var(--border); }
